        ...
        protected void CopyAgreement(Agreement agreement)
        {
            ...
            foreach(var siteF in siteFunding)
            {
                copyMod.FundingSites.Add(new FundingSite()
                {
                    ...
                    StartDate = Convert.ToDateTime(siteF.StartDate).AddYears(1),
                    EndDate = Convert.ToDateTime(siteF.EndDate).AddYears(1),
            ...
            foreach(var studiesF in studiesFunding)
            {
                copyMod.FundingStudies.Add(new FundingStudy()
                {
                    ...
                    StartDate = Convert.ToDateTime(studiesF.StartDate).AddYears(1),
                    EndDate = Convert.ToDateTime(studiesF.EndDate).AddYears(1),
                    CreatedBy = user.ID,
                    CreatedDate = DateTime.Now,
                    ModifiedBy = user.ID,
                    ModifiedDate = DateTime.Now
