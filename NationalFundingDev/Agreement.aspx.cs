...
namespace NationalFundingDev
{
    public partial class AgreementPage : System.Web.UI.Page
    {
        ...
        {
            if (e.Tab.TabIndex == 20) Response.Redirect(String.Format("https://water.wr.usgs.gov/cgi-bin/attachment-ca.cgi?AgreementID={0}", agreement.AgreementID));
            if (e.Tab.TabIndex == 21) Response.Redirect(String.Format("https://water.wr.usgs.gov/cgi-bin/attachment.cgi?AgreementID={0}", agreement.AgreementID));
