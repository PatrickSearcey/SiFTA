...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="server">
    ...
    <center>
        ...
        <asp:PolygonHotSpot HotSpotMode="Navigate" Coordinates="470,54,491,45,549,64,537,79,523,87,523,100,517,103,520,120,540,139,476,142" NavigateUrl="~/Center.aspx?OrgCode=GENK" AlternateText="Minnesota" />
        <asp:PolygonHotSpot HotSpotMode="Navigate" Coordinates="538,190,489,190,476,158,475,143,538,142,540,150,554,162" NavigateUrl="~/Center.aspx?OrgCode=GENE" AlternateText="Illinois-Iowa" />
        ...
        <asp:PolygonHotSpot HotSpotMode="Navigate" Coordinates="579,69,544,82,550,89,573,94,581,103,589,110,593,163,632,160,646,138,630,97,604,78" NavigateUrl="~/Center.aspx?OrgCode=GENK" AlternateText="Michigan" />
        <asp:PolygonHotSpot HotSpotMode="Navigate" Coordinates="549,155,578,155,585,166,589,213,581,225,583,230,579,243,566,243,554,223,556,216,541,191,554,163" NavigateUrl="~/Center.aspx?OrgCode=GENE" AlternateText="Illinois-Iowa" />
