<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MapControl.ascx.cs" Inherits="NationalFundingDev.MapControl" ClassName="MapControl" %>
<script type="text/javascript" src="http://sifta.water.usgs.gov/NationalFunding/SiftaMapUtils/jquery/jquery-1.11.1.min.js"></script>
<script type="text/javascript" src="http://sifta.water.usgs.gov/NationalFunding/SiftaMapUtils/MapUtils/MapUtils.js"></script>
<style type="text/css">
    .legend {
        position: absolute; 
        top: 50px; 
